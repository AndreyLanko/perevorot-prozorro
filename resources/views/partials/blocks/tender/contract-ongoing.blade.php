                ...
                <table class="tender--customer tender--customer--table margin-bottom">
                    <tbody>
                        <tr>
                            ...
                            <td class="col-sm-4"><strong>{{!empty($item->__contract_ongoing->period->startDate) ? date('d.m.Y', strtotime($item->__contract_ongoing->period->startDate)) : 'не вказанa'}} — {{!empty($item->__contract_ongoing->period->endDate) ? date('d.m.Y', strtotime($item->__contract_ongoing->period->endDate)) : 'не вказанa'}}</strong></td>
                        </tr>
                        <tr>

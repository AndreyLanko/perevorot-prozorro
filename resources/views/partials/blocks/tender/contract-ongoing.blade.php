                ...
                <table class="tender--customer tender--customer--table margin-bottom">
                    <tbody>
                        <tr>
                            ...
                            <td class="col-sm-4"><strong>{{date('d.m.Y', strtotime($item->__contract_ongoing->period->startDate))}} — {{date('d.m.Y', strtotime($item->__contract_ongoing->dateModified))}}</strong></td>
                        </tr>
                        <tr>
